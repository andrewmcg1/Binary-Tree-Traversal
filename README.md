...
The main function takes the in order and pre order traversals and uses those to return the post order traversal. The tree and functions included support for repeat characters.
